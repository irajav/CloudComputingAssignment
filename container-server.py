...
def containers_remove_all():
    ...
    return Response(response='All containers are removed', mimetype="application/json")
...
def images_remove_all():
    ...
    return Response(response='All images are removed', mimetype="application/json")
